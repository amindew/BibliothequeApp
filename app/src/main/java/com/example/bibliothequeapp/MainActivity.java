...
public class MainActivity extends AppCompatActivity {
    ...
    private void initialiserLivres() {
        ...
        listeLivres.add(new Livre(1, "Le Petit Prince", "Antoine de Saint-Exupéry", "9780156013987", true, R.drawable.le_petit_prince));
        listeLivres.add(new Livre(2, "L'Étranger", "Albert Camus", "9782070360024", false, R.drawable.etranger));
        listeLivres.add(new Livre(3, "Les Misérables", "Victor Hugo", "9782253096344", true, R.drawable.les_miserables));
        listeLivres.add(new Livre(4, "Une si longue lettre", "Mariama Bâ", "9782841290529", true, R.drawable.lettre));
        listeLivres.add(new Livre(5, "Le Vieux Nègre et la Médaille", "Ferdinand Oyono", "9782264018304", false, R.drawable.oyono));
        listeLivres.add(new Livre(6, "Madame Bovary", "Gustave Flaubert", "9782070409228", true, R.drawable.bovary));
        listeLivres.add(new Livre(7, "La Peste", "Albert Camus", "9782070360420", false, R.drawable.peste));
        listeLivres.add(new Livre(8, "Sous l'orage", "Seydou Badian", "9782708707691", true, R.drawable.orage));
    }
